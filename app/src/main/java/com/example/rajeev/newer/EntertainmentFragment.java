...
public class EntertainmentFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<Article>>{
    ...
    private static final String SAMPLE_URL = "https://newsapi.org/v2/top-headlines?category=entertainment&language=en&country=&apiKey=e591d4b34f2e435ba3d8a1f4d4f0d185";
