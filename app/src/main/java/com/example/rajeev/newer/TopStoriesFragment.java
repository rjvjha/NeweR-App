...
public class TopStoriesFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<Article>>{
    ...
    private static final String SAMPLE_URL = "https://newsapi.org/v2/top-headlines?category=general&country=in&pageSize=30&apiKey=e591d4b34f2e435ba3d8a1f4d4f0d185";
